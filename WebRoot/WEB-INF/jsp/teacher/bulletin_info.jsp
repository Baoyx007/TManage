...
<html lang="en">
    ...
    <body >
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="${myContext}/servlet/PublishSubjectUIServlet">发布论题</a></li>
                                    <li><a href="${myContext}/servlet/ListSubjectServlet">我的论题</a></li>
        ...
        <div class="container">
            ...
            <br>
            <a class="btn pull-right" href="javascript:history.go(-1);">返回</a>
        </div>
