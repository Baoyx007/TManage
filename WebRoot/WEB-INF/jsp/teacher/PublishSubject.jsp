...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function submitContent() {
                frm.description.value = $('#editor').html();
                frm.submit();
            }
        </script>
    </head>
    <body>
        ...
        <div class="container">
            <form name="frm" action="${myContext }/PublishSubjectServlet" method="post">
                <input type="hidden" name="id" value="${subject.id}"/>
                <input type="hidden" name="description" value="">
                <div class="hero-unit">
                    <h2>  题目:<input type="text" name="title" value="${subject.title}"  /></h2> 
                    <hr>
                    <div id="alerts"></div>
                    ...
                    <div id="editor"contenteditable="true">${subject.description==null?'在此输入内容':subject.description }</div>
                </div>
                <div class="pull-right" ><input class="btn btn-primary" type="button" value="提交" onclick="submitContent();"/></div>
