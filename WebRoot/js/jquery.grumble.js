        ...
        return this.each(function() {
            ...
            _private = {
                ...
                createFxQueue: function() {
                    ...
                    if (button)
                        button.delay(options.showAfter);
                },
                showBubble: function() {
                    if (_private.isVisible == true)
                        return;

                    if (options.showAfter)
                        _private.createFxQueue();
                    ...
                    grumble.bubble.queue('fx', function(next) {
                        ...
                        if (options.hideOnClick || options.hasHideButton)
                            _private.hideOnClick();
